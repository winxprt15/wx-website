...
PlaylistHtml += `<span class="song-names song-name-${ind}" onclick="CurrentSongNum = ${ind}; document.querySelector('.audio').src = \`${SongArray[ind]}\` + '.mp3'; document.querySelector('.audio').play(); RenderMusicInfo();" style="cursor: pointer; color: yellow; display: inline-block;">» ${ind+1}. ${SongArray[ind]}</span>\n`;
continue;
}
PlaylistHtml += `<span class="song-names song-name-${ind}" onclick="CurrentSongNum = ${ind}; document.querySelector('.audio').src = \`${SongArray[ind]}\` + '.mp3'; document.querySelector('.audio').play(); RenderMusicInfo();" style="cursor: pointer; display: inline-block;">${ind+1}. ${SongArray[ind]}</span>\n`;
}
