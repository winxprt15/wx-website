...
document.querySelector(".intro-span").style.paddingLeft = document.querySelector(".side-div-div").style.display == "block" ? "170px" : "0px";
document.querySelector(".intro-heading").style.paddingLeft = document.querySelector(".side-div-div").style.display == "block" ? "170px" : "0px";
